...
from .blocks import _make_scratch, _make_fusion_block_scale_residual_block

class DPTHeadCustomised(nn.Module):
    def __init__(self,
                 in_channels,
                 features=256,
                 ...
                 use_clstoken=False,
                 output_act='identity'):
        super(DPTHeadCustomised, self).__init__()
    ...
    def forward(self, out_features, patch_h, patch_w, prompt_depth=None):
        ...
        #replaced with line below for onnx exportation
